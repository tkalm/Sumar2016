...
set output 'plotx4l10k8zoom.eps'
set size 2,1
...
{Initalial state |5>, {/Symbol k} = 0.05E_0, \n \
...
# Plot 
plot for [col=2:7] "Dataset1/nit.dtx" using 1:col with lines ls col title columnheader,\
#     for [col=2:7] "Dataset2_k4/nit.dtx"  using 1:col with lines ls 3 title columnheader,\
