...
# Header
set title "Time evolution of the occupation of states x^2 + 0.4x^4\n \
{Initalial state |0>, {/Symbol k} = 0.1E_0 (yellow/red) and {/Symbol k} = 0.02E_0 (green), \n \
