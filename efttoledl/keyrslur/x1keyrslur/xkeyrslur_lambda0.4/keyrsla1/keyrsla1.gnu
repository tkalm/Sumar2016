...
{Initalial state |0>, {/Symbol k} = 0.2E_0 (blue) and {/Symbol k} = 0.05E_0 (yellow/red), \n \
...
# Plot 
plot for [col=2:5] "Dataset1_kappa0.2/nit.dtx"  using 1:col with lines ls col+4 title columnheader,\
